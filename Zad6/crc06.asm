...
ftext      db   "RBX:RCX %x",0
ftext2     db   ":%x",10,13,0
ftexta     db   10,13,"RAX:%x",10,13,0
...
; -----------------------------
		...
		xor dl, cl	; cl <-- next char	; index = dl
		...
		mov dl, ah      ; index = HiByte ^ *pMessage
		xor dl, ch	; cl <-- next char	; index = dl
		...
		; rbx
		mov dl, ah      ; index = HiByte ^ *pMessage
		xor dl, bl	; cl <-- next char	; index = dl
		...
		mov dl, ah      ; index = HiByte ^ *pMessage
		xor dl, bh	; cl <-- next char	; index = dl
